...
('Kloopocar Garage', 'Official community for Kloopocar project discussions.', '["https://via.placeholder.com/300/9C27B0"]');
...
(3, 'Kloopocar First Edition', 'The first collectibles released by Kloopocar.', '["https://via.placeholder.com/200/673AB7"]'),
...
('Kloopocar Genesis Collection', '{"artist": "AI Generated", "releaseDate": "2025-01-01"}', 'Online');
...
('Kloopocar Foundation', 'Supporting automotive heritage and innovation', '{"website": "https://www.kloopocar.org", "instagram": "@kloopocar_official"}', 'Dedicated to preserving and promoting automotive culture.', '["https://via.placeholder.com/120/795548"]', 'Berlin', 'Germany');
...
(3, 3, 'This collectible is brought to you by the Kloopocar Foundation.');
...
('Kloopocar Platform Launch', 'We are excited to announce the official launch of the Kloopocar platform!', 'Kloopocar platform is now live!', 'announcement', '["https://via.placeholder.com/400/9C27B0"]');
...
(3, 'Kloopocar Explorer', 'View 5 different Kloopocar collectibles.', 'Unique profile banner', 5);
...
(3, 'Kloopocar Trivia Challenge', 'Test your knowledge about Kloopocar collectibles.', 'Exclusive Kloopocar collectible', 3, '2025-05-10', '2025-05-17', '["https://via.placeholder.com/600/9C27B0"]');